 ...
 * @author Payam
 */
public class UpdateDescriptionFormServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateDescriptionFormServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
