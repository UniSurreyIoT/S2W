...
public class ServiceConfigParams extends ConfigParameters {
    ...
    public static final String ONTOLOGY_LOCAL_URL = "/IoTA-Models/ServiceModel.owl";
    ...
    public static final String STM_1 = "/prob_engine/iot-a/Service/STM1.data";
    public static final String STM_2 = "/prob_engine/iot-a/Service/STM2.data";
    public static final String LDA_model = "/prob_engine/iot-a/Service/LDA_Model.data";
    public static final String unseen_concepts = "/prob_engine/iot-a/Service/unseen.data";
    public static final String index = "/prob_engine/iot-a/Service/index.db4o";
